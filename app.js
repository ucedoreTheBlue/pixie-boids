...
function renderBoids(x, y, c) {
    ...
    app.ticker.add(() => {
        ...
        flightData[y/5].distances.pop();
        xSquared = Math.pow((xcoordinate - xcoordinate*2), 2);
        ySquared = Math.pow((ycoordinate - ycoordinate*2), 2);
        flightData[y/5].distances.push(Math.sqrt(xSquared+ySquared));
        boid.clear();
